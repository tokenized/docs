...
<div class="ritz grid-container" dir="ltr">
    <table class="waffle" cellspacing="0" cellpadding="0" table-layout=fixed width=100%>
       ...
       <tr>
            ...
            <td class="r10">Sends Bitcoin back to itself less mining fees.</td>
        </tr>
    ...
    <div class="content docs-content">
        <table class="ui table">
            ...
            <tr>
                ...
                <td class="r10">13</td>
                <td class="r10">tokenized.com</td>
                <td class="r10" style="word-break:break-all">Tokenized ID Prefix. tokenized.com</td>
                <td class="r10">byte</td>
                <td class="r10"></td>
            </tr>
            <tr>
                ...
                <td class="r10">1</td>
                <td class="r10">0x4d</td>
                <td class="r10" style="word-break:break-all">PACKET LENGTH, PUSHDATA1 (76), PUSHDATA2 (77), or PUSHDATA4 (78) depending on total size of action payload.</td>
                <td class="r10">byte</td>
                <td class="r10"></td>
            </tr>
            <tr>
                ...
                <td class="r10"></td>
                <td class="r10">tokenized.com</td>
                <td class="r10" style="word-break:break-all">Length of the action message (0 - 65,535 bytes). 0 if pushdata length <76B, 1 byte if PUSHDATA1 is used, 2 bytes if PUSHDATA2 and 4 bytes if PUSHDATA4.</td>
                <td class="r10">byte</td>
                <td class="r10">Size depends on Action Payload.</td>
            </tr>
            <tr>
                ...
                <td class="r10">1</td>
                <td class="r10">0</td>
                <td class="r10" style="word-break:break-all">255 reserved for additional versions. Tokenized protocol versioning.</td>
            ...
            <tr>
                ...
                <td class="r10">2</td>
                <td class="r10">R1</td>
                <td class="r10" style="word-break:break-all">// R1 identifies data as a Establishment message.</td>
