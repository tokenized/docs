##Tokenized Order of Operations
For each set of actions performed within a Tokenized smart contract environment, there is a specific order that must be respected by the users and issuers to ensure that the smart contract will deliver the desired responses.
...
####1B. Initiative
An initiative is the method used for an asset owner to propose a hsareholder vote. There is a significant cost attached to the initiative action as conducting a vote is a costly and disruptive exercise.
####2. Vote
