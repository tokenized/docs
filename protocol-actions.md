...
<table>
    ...
    <tr>
        ...
        <td>
            Set to true if the issuer is permitted to make enforcement orders on user tokens and balances, otherwise set to false to disable this feature.
             Example: 1
        </td>
    </tr>
    <tr>
...
<table>
   ...
   <tr>
        ...
        <td>This action can only come from the issuer.</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            Can't be changed by issuer or smart contract operator. Example: 0
        </td>
    </tr>
    <tr>
        <td>Timestamp</td>
...
<table>
    ...
    <tr>
        ...
        <td>
            Who initiated the proposal. Supported values: 0 - Issuer, 1 - Holder
