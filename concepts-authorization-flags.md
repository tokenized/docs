...
![Order of Operations](https://raw.githubusercontent.com/tokenized/docs/master/images/concepts-authorization-flags.svg?sanitize=true "Order of Operations") {.frame .centered .padded}
